...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "moviecollection" because\n';
  ...
  $wnd.__gwt_activeModules['moviecollection'] = {
    'moduleName' : 'moviecollection',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/moviecollection.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['moviecollection'].superdevmode = true;

  var expectedSuffix = '/moviecollection.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + moviecollection + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:moviecollection';
  var devModeSessionKey = '__gwtDevModeSession:moviecollection';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/moviecollection/moviecollection.nocache.js';
  ...
  $wnd.__gwt_activeModules['moviecollection'].canRedirect = true;
  $wnd.__gwt_activeModules['moviecollection'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING moviecollection';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/moviecollection?user.agent=' + ua + '&_callback=' + callback;
